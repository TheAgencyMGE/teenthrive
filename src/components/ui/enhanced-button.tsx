  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-smooth focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        hero: "gradient-hero text-primary-foreground hover:scale-105 shadow-glow animate-pulse-glow",
        success: "bg-secondary text-secondary-foreground hover:bg-secondary/80 shadow-float",
        accent: "gradient-accent text-accent-foreground hover:scale-105 shadow-glow",
        teen: "bg-primary text-primary-foreground hover:bg-primary-glow shadow-glow animate-bounce-in"
      },
      size: {
